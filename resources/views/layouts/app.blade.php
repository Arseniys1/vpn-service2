            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @endauth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('servers.index', ['locale' => App::getLocale()]) }}">{{ __('app.servers_list') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('servers.free', ['locale' => App::getLocale()]) }}">{{ __('app.free_servers_list') }}</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login', ['locale' => App::getLocale()]) }}">{{ __('app.login') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register', ['locale' => App::getLocale()]) }}">{{ __('app.register') }}</a>
                                </li>
                            @endif
                        @else
